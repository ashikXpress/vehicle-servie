...
{
    protected $fillable = [
        'name', 'employee_id', 'dob', 'joining_date', 'confirmation_date', 'employee_category',
        ...
        'gross_salary', 'salary_in_jolshiri', 'bank_account', 'weight',
        'height_total_inch', 'height_inch', 'height_foot'
    ];
