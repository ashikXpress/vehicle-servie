    ...
    public function transactionDatatable() {
        ...
        return DataTables::eloquent($query)
            ...
            ->addColumn('action', function(Transaction $transaction) {
                return '<a href="'.route('transaction.details', ['transaction' => $transaction->id]).'" class="btn btn-warning btn-sm">Details</a> <a role="button" data-id="'.$transaction->id.'" class="btn btn-warning btn-sm btn-edit">Edit</a>';
            })
