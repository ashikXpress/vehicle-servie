                    ...
                    <table id="table" class="table table-bordered table-striped">
                        ...
                        @foreach($suppliers as $supplier)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-warning btn-sm btn-pay" role="button" data-id="{{ $supplier->id }}" data-name="{{ $supplier->name }}">Pay</a>

                                    @if($supplier->refund > 0)
                                        <a class="btn btn-warning btn-sm btn-refund" role="button" data-id="{{ $supplier->id }}" data-name="{{ $supplier->name }}">Refund</a>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
                    ...
                    <form id="modal-form" enctype="multipart/form-data" name="modal-form">
                        ...
                        <div class="form-group" id="fg-next-payment-date">
                            ...
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control pull-right" id="next-payment-date" name="next_payment" autocomplete="off">
                            </div>
                            <!-- /.input group -->
                        </div>
    ...
    <div class="modal fade" id="modal-refund">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-warning" id="modal-btn-refund">Refund</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
