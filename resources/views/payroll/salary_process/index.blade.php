                ...
                <div class="box-body">
                    <form action="{{ route('payroll.salary_process.index') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div id="account_balance_area" style="display: none">
                                <div class="form-group">
                                    <label>Balance</label>
                                    <input class="form-control" id="account_balance" name="account_balance" readonly>
                                </div>
                            </div>
                            </div>
        ...
        $(function () {
            ...
            $('#account').change(function (){
                ...
                if (accountId != '') {
                    $.ajax({
                        method: "GET",
                        url: "{{ route('get_bank_account_balance') }}",
                        data: { accountId: accountId }
                    }).done(function( response ) {
                        $('#account_balance').val(response.balance.toFixed(2));
                        $('#account_balance_area').show();
                    });
                }
            });
